...
import { createComment } from '../lib/createCommentApi'

export default function CreateComent({id}) {
const queryClient = useQueryClient()


    const {isPending,data,mutate}=useMutation({mutationFn:createComment,onSuccess:()=>queryClient.invalidateQueries({ queryKey: ['comments',id] })
})
    function addcommentfun(e){
